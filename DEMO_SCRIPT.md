...
> "다음 달 서초·영등포·중구 중 어디에서 전입·이사 직후 홈서비스 수요를 가장 먼저 잡아야 하는가?"
>
> 기존 방식은 경험과 감에 의존합니다.
...
> [Streamlit Capture Plan 탭 → Ablation 차트 클릭]
>
...
### [8:10-9:00] 왜 이 도메인이 강한가 (슬라이드 9-10)

> 이 프로젝트는 단순한 지역 대시보드가 아닙니다.
> SPH는 생활권 소비와 유동을 설명하고,
> Richgo는 전입·이사 신호를 설명하며,
> optional AJD는 실제 렌탈/CS/운영 액션으로 닫습니다.
> 즉, 도메인 자체가 파트너 데이터와 가장 잘 맞습니다.
...
> 홈서비스/렌탈 사업자의 Growth 팀과 운영 팀이 같은 계정에서
> 전입 신호 감지, 집행 우선순위, 운영 제약 반영까지 한 번에 할 수 있다는 점이 핵심입니다.
